        ...
        <aside className={ s.aside }>
            ...
            <nav className={ s.asideNav }>
                <ul className={ s.asideMenu }>
                    ...
                    <li>
                        <NavLink to={ '/about' } activeClassName={ s.selected }>About</NavLink>
                        <FontAwesomeIcon icon={ faLongArrowAltRight }/>
                    </li>
                    <li>
                        <NavLink to={ '/portfolio' } activeClassName={ s.selected }>Portfolio</NavLink>
                        <FontAwesomeIcon icon={ faLongArrowAltRight }/>
                    </li>
                </ul>
                <ul className={ s.asideContacts }>
                    ...
                    <li>
                        <a rel='noreferrer' target='_blank'
                           href="https://www.linkedin.com/in/victor-poltoratchi-279b141a3/">
