                        ...
                        props.portfolio.map( ( item, index ) => {
                            return (
                                <div key={ `item-${ index }` } className={ s.item }>
                                    ...
                                    <Fancybox>
                                        <a data-fancybox='' href={ item.img === null ? notFound : item.img }
                                           className={ s.img }>
                                            <img src={ item.img === null ? notFound : item.img } alt="project_logo"/>
                                        </a>
                                    </Fancybox>
                                    ...
                                    <div className={ s.info }>
                                        ...
                                        <div className={ `${ s.infoGithub } ${ s.infoItem }` }>
                                            <span className={ s.title }>Github <FontAwesomeIcon
                                                icon={ faGithub }/> : </span>
                                        ...
                                        <div className={ s.technologies }>
                                            <span className={ s.title }>Technologies <FontAwesomeIcon
                                                icon={ faMicrochip }/> : </span>
                                            <ul>
                                                {
